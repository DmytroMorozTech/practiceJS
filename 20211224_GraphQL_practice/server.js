// Source video that I was using to study this topic:
...
const RootQueryType = new GraphQLObjectType({
    ...
    fields: () => ({
        book: {
            ...
            // if we had a real production project, we would most likely make a DB-query here to get this data
        },
        books: {
            type: new GraphQLList(BookType),
