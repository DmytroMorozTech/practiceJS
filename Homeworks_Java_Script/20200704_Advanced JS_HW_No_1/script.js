// ES5 standard should be followed!
...
// in ES6 syntax this line will transform into: "class HamburgerException extends Error"
...
Hamburger.prototype.calculatePrice = function() {
    var toppingsPrice = this.toppings.reduce(function(acc,topping){
            return acc + topping.price;
        },0);
    var currentPrice = this.size.price + this.stuffing.price + toppingsPrice;
    console.log(`Current price: ${currentPrice}`);
}

Hamburger.prototype.calculateCalories = function() {
    var toppingsCalories = this.toppings.reduce(function(acc,topping){
        return acc + topping.calories;
    },0);
    var currentCalories = this.size.calories + this.stuffing.calories + toppingsCalories;
...
try {
    var hamburger2 = new Hamburger("",Hamburger.STUFFING_SALAD);
...
console.log("------------------------------");
try {
    var hamburger3 = new Hamburger(Hamburger.SIZE_SMALL,"");
